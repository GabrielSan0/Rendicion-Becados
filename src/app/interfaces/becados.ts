...
export const BECADOS_DATA: AuthUser[] = [
  // 15 Becados
  { username: 'lsanchez', name: 'Lucas Sanchez', dni: '66666666' },
  ...
  { username: 'folortegui', name: 'Franklin Olortegui Dominguez', dni: '60022089' },
  { username: 'yrequez', name: 'Yeff Yayko Requez Flores', dni: '60623170' },
  ...
  { username: 'javelino', name: 'Avelino Avendaño Jearen', dni: '61035191' },
  ...
  { username: 'msamar', name: 'Margarita Samar Carhuas', dni: '60567906' },
  { username: 'lchavez', name: 'Luz Yadira Chavez Ramirez', dni: '60228196' },
  { username: 'jperezhuiza', name: 'Jairo Irven Perez Huiza', dni: '61276579' },
